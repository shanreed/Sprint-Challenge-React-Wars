...
- [x] What is React JS and what problems does it try and solve? Support your answer with concepts introduced in class and from your personal research on the web.
        React is a JavaScript User Interface Library tool created by facebook for building User Interface components. These components are reusable pieces of code that render some kind of output to the screen. 

- [x] What does it mean to _think_ in react
        To think in react means to think about exactly you want to happen within the application to accomplish DRY. 

- [x] Describe state.
        State is an object that holds data and controls the changing part of the application.
- [x] Describe props.
      Props are what carry the data from one place to another, the props allow the data to move.
